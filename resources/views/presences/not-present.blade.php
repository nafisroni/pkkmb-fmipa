...
<div class="btn-toolbar mb-2 mb-md-0">
    <div>
        <a href="{{ route('presences.show', $attendance->id) }}" class="btn btn-sm btn-danger">
...
<div class="container">
    <div class="row">
        <div class="mt-2 mb-2">
            <small class="alert alert-danger">JANGAN TEKAN TOMBOL <span class="fw-bold rounded-2 bg-primary text-light fs-7"> HADIR</span> JIKA INGIN SELAMAT!!!</small>
        </div>
    </div>
</div>
